...
public class VersionParser extends AbstractBaseParser {
	...
	//https://github.com/axfly00q/BilibiliDown/releases/download/V5.3/BilibiliDown.v5.3.release.zip
	...
	private String getDownUrl(String version, String file) {
		...
		String pattern = Global.settings.getOrDefault(key, "https://github.com/axfly00q/BilibiliDown/releases/download/V{version}/{file}");
